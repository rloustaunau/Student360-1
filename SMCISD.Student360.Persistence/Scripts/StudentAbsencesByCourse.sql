...
select sched.StudentUSI, sched.SchoolId,  sched.LocalCourseCode,  sched.SectionIdentifier, sched.AvailableCredits Credits, 
  ...
  SessionName, TeacherLastSurname, Room = LocationClassroomIdentificationCode, ClassPeriodName,  
  	   'MARK9W1' = (select top 1 LetterGradeEarned from edfi.Grade gr where gr.StudentUSI = sched.StudentUSI and gr.LocalCourseCode = sched.LocalCourseCode and 
	       sched.SectionIdentifier = gr.SectionIdentifier and gr.GradingPeriodSequence = 1),
	   'MARK9W2' = (select top 1 LetterGradeEarned from edfi.Grade gr where gr.StudentUSI = sched.StudentUSI and gr.LocalCourseCode = sched.LocalCourseCode and
	      sched.SectionIdentifier = gr.SectionIdentifier and gr.GradingPeriodSequence = 2 ),
	   'MARK9W3' = (select top 1 LetterGradeEarned from edfi.Grade gr where gr.StudentUSI = sched.StudentUSI and gr.LocalCourseCode = sched.LocalCourseCode  and
	      sched.SectionIdentifier = gr.SectionIdentifier and gr.GradingPeriodSequence = 3 ),
	   'MARK9W4' = (select top 1 LetterGradeEarned from edfi.Grade gr where gr.StudentUSI = sched.StudentUSI and gr.LocalCourseCode = sched.LocalCourseCode and 
	      sched.SectionIdentifier = gr.SectionIdentifier and gr.GradingPeriodSequence = 4 ),
